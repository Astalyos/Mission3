...
router.get('/', async function (req, res, next) {
    ...
    await Film.find({"commentaires.uid": getUid},{"commentaires.commentaire":1,"commentaires.note":1,"title":1,"poster_path":1,"overview":1,"release_date":1,"genre":1,"idFilm":1},
